...
import com.rerloan.basic.dic.DicImpl;
...
public class LogUtil {
    ...
    public static Map<String, String> getNotErrorMap() {return notErrorMap;
    }
    ...
    public static TranFailException handerEx(DicImpl errorMsg) {

        return handerEx(errorMsg, EMPTY, null);
    ...
    public static TranFailException handerEx(DicImpl errorMsg, Throwable e) {

        return handerEx(errorMsg, EMPTY, e);

    }

    public static TranFailException handerEx(DicImpl errorMsg, String level) {

        return handerEx(errorMsg, level, null);

    }

    public static TranFailException handerEx(DicImpl errorMsg, String level, Throwable e) {


        return handerEx(getLogClass(), getLogMethod(), errorMsg.key().toString(),errorMsg.value().toString(), level, e);
