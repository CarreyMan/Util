...
public class PinyinUtil {
     ...
     * 将文字转为汉语拼音
     */
    public String toHanyuPinyin(String text){
        ...
        try {
            ...
            logger.error("字符串[{}]不能转成汉语拼音，异常信息：{}", text, e);
        }
        return hanyupinyin;
    }
    ...
    public static String getFirstLetters(String text,HanyuPinyinCaseType caseType) {
        char[] cl_chars = text.trim().toCharArray();
        String hanyupinyin = "";
        HanyuPinyinOutputFormat defaultFormat = new HanyuPinyinOutputFormat();
